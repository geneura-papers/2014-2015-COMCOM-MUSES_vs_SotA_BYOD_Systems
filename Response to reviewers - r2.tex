...
The paper structure has been completely redefined, with an introduction
...
\textcolor{blue}{TODO - computational costs? Al menos en el cliente, y la correlaciÛn + risk and trust en el servidor, ya que no se ha llegado a aplicar lo del KRS. Aunque sea muy aproximado (segundos, milisegundos)}
