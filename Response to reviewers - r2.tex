...
% Antonio - Voy a sustituir el Verbatim por un cambio de color en las respuestas porque al compilarlo no hace los saltos de línea si no se los especificas y el texto se sale del margen.
...
This section has been rewrited, and the references mentioned by the referee (including new products) have been added. %FERGU: PONED ESTO MÃS BONICO!
...
\textcolor{blue}{TODO: Tabla comparativa - ¿se va a meter, Antares?}
...
\textcolor{blue}{The reviewer is right. We have fixed this in the text.}
