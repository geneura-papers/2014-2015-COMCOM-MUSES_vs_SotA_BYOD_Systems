...
Moreover, MUSES offers visual analysis tools to the CSOs, which can aid (or guide) they to detect suspicious or anomalous patterns, and to study how to avoid these patterns becoming malicious to the company.

In order to clarify this we have rewritten and completed the second paragraph in section 4.1 (page XX). It is now:
