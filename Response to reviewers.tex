...
We really appreciate the opportunity for improving our work. Following the reviewers' requests and suggestions we have deeply changed the contents, and  thus, the quality of the paper. 

In the next paragraphs you can find these comments and our responses to every one, along with the changes done.\\
...
\textit{Following your comments and the reviewers' requests we have deeply revised and updated the paper.
The changes include the rewriting of several sections, clearer and more complete explanations, a wider and more appropriate description of the state of the art in BYOD-focused and corporate security solutions, a better comparison with MUSES system.}

\textit{This can be noticed in the text, but as an example, more than 15 references have been added or updated, which have been used to clarify, describe more precisely and update the contents.}\\
...
Section 3, for instance has been almost completely rewritten and updated, including the commented clues. Section 5 has also been improved, comparing these solutions with the current features of the MUSES prototype, which is already being used in tests. This shows a clearer description of the advantages of MUSES with respect to the analyzed tools and applications.

Moreover the abstract and introduction have been also rewritten in order to describe the aim and contents of the paper, and the conclusions have been improved. % [Pedro] I propose rewrite this sentence as follows: "Moreover, both the abstract and introduction sections have been rewritten .... and the conclusions have also been improved."
...
[12] A. Mora, P. De las Cuevas, J. J.  Merelo, Going a step beyond the black and
white lists for url accesses in the enterprise by means of categorical classifiers, in: A. Rosa, J. J. Merelo, J. Filipe (Eds.), ECTA 2014 - Proceedings of the International Conference on Evolutionary Computation Theory and Applications, 2014, pp. 125-134.

Now the paper presents a more complete and accurate survey/state-of-the-art on BYOD-focused and corporate security tools and applications, a deeper description of the system, and a better comparison between MUSES and the described tools.

More than 15 new references have been included and commented.
...
% [Pedro] add: "in the MUSES project."
...
Security and privacy are the main concerns of MUSES: data
...
The first response to Reviewer \#2 presents an outline of the work done in the revision.

We are very grateful to the reviewer for his/her comments and hope he/she can turn his/her opinion considering all these changes and improvements in the paper.
...
The reviewer is right in part, since we consider that some of the contents can be the same when a system is being described.
However, we have followed his/her requests and changed/improved several parts in
the text, namely:  
\begin{itemize}
\item The abstract and introduction have been rewritten.
\item The background has been rewritten, corrected and expanded.
\item References to papers mentioned by the reviewer and how they
...
\item Many more papers have been reviewed and referenced. The
  bibliography section has grown in more than 15 references. Others have been updated to more recent news and URLs.
\item BYOD and corporate security solutions have been better described and compared among themselves. Section 3 has been rewritten in a big part, changing its structure and including new tools and features.
\item The description of the system has been completed and better explained in Section 4.
\item The comparison between these tools and MUSES have been completed and improved in Section 5.
\item The conclusions have been extended.
\item The paper reflects the current, so far unpublished, state of
  Muses architecture and implementation, since first prototype has been released some months ago. 
\end{itemize}
...
We have focused the paper the paper in the state-of-the-art of systems that offer functionalities that are similar to MUSES. As stated, the paper has been almost completely rewritten to reflect the state of the art including changes from the time the first paper was submitted (Samsung dropping KNOX, for instance). 
...
a "state of the art" of tools for corporate mobile security. They
...
has been better described and compared with the existing tools in a more detailed way. All sections have been rewritten and new sub-sections have been added to more accurately reflect the state of the art. 
...
This observation is very much appreciated since it is true that what was written could lead to a misunderstanding. The description has been changed (now in page 11), and the context properly defined and explained.
...
The reviewer is right. We have rewritten the paragraph (in page 12) justifying the use of a server machine due to its computational power, needed for
...
We strongly agree with this and a detailed description of the encryption methods, that the second prototype of MUSES will implement, has been included by the end of the introduction of section 4 (page 13).
...
We have included a text describing what are sensors and actuators and giving some examples of a few of the sensors that MUSES includes. It is described by the end of page 13 and in the following paragraphs (when the MUSES Aware Apps are commented).
...
Following your comment, the description of the performance of the CRTEP has been extended and improved (in section 4.2, page 15), with references to two Project Reports which better fit to the contents. 
...
The reviewer is right, the way user data is anonymised in the system, as long as other legal aspects about the data privacy, have been properly detailed, as well
as complemented with a reference. It is written in the last paragraph of page 15.  %where and which one?

We really appreciate the reviewer's comments and hope that he/she will be satisfied with the revised work.
