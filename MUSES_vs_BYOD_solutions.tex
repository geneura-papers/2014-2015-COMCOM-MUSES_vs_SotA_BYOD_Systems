...
submitted. Also, an additional work on the data mining techniques was conducted in \cite{mora14:urls}, over a set of data previous to the release and test of the first MUSES prototype. As there was no available test data, a set of URL connection logs were provided by a Spanish company, % [Pedro] quizás decir que es una empresa de seguridad o algo así
...
By taking the lists as `rules', and the HTTP connections as `events', a previous simulation of the rule generation through classification, and its results, could be presented at \cite{mora14:urls}. % [Pedro] ¿ese "could be" se refiere a verbo en pasado? en ese caso, quizás usar "... was presented at..."
Now, after the release of the first prototype, along with the first conducted tests, we have a clearer idea of MUSES capabilities and, as such, they will be presented in this paper. % [Pedro] Quizás comenzar la frase con: In this paper, once the first prototipe has been released and the first tests have been conducted, we ...
