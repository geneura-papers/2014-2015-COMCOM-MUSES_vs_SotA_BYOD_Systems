...
Security Policies. In addition, it has the ability of `learning' from the user's past behavior and adapt the set of existing rules, or even inferring new ones,
...
To this end, MUSES analyses the users' behavior by means of Data
