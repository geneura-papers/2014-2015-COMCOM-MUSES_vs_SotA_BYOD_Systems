...
Furthermore, the lack of information about this system makes difficult to determine its real qualities.
...
A MUSES first prototype, implemented on Android devices, has been tested recently. These trials have been conducted in an actual Spanish company (a partner in the European Project where the system is being developed), with 50 employees using the system on their own devices.
...
As a results, not only the number of security violations were reduced by half in the first two weeks (10977), but the number went on decreasing until it was 0 before the trials period finished. Thus, we can assume that MUSES is an effective tool.
...
%  }
\end{footnotesize}
  \caption{Features of the analyzed tools regarding the proposed taxonomy to classify BYOD systems (see Section \ref{sec:toolsreview}).}
  \label{tab:taxonomy}
\end{table}
