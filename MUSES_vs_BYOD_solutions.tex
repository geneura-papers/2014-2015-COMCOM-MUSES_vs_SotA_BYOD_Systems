...
On the other hand, %Antares needed
...
As part of its SAFE (Samsung for enterprise) brand, Samsung revealed at the Barcelona Mobile World Congress 2013 the Knox application \cite{Samsung_mwc13}, which was expected to be available on its last Galaxy smartphone generation. It was also presented in the same congress in 2014 \cite{Samsung_mwc14}, but... %Completar cuando encuentre la noticia
