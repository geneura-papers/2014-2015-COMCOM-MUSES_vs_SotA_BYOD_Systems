...
\begin{description}
  ...
  \item[DEVICE PROTECTION SENSOR] Which scans device security settings, such as the time until the device screen tunrs off, or if the device has the screen protected with a password. This sensor adds the possibility of detecting security violations event if the user is not doing a specific action.
