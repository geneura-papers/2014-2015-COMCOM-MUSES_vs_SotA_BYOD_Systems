...
mentioned above. In this paper we propose a  taxonomy to classify the features
of BYOD systems. This taxonomy is used to present an overview of BYOD security
solutions.

Also, we describe a novel, adaptive and free software system named
...
users' behavior in order to adapt, improve, and even increase the
...
affects it. A taxonomy of BYOD systems, with the main solutions or tools available
...
A taxonomy has been proposed to compare MUSES with other existing solutions with a similar aim: enduring the protection and privacy of sensitive information in the enterprise when it is accessed by the employees using their own devices (BYOD philosophy).
The main advantages of MUSES with respect to the other solutions have
been discussed, remarking its advances beyond the state of the art. %¿El estado del arte que define a estas
                         %herramientas? ¿Qué es eso? - JJ FERGU: fuera
