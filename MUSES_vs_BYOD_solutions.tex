...
These are not only advantages of MUSES over the existing products, but also a progress beyond the state of the art in some fields like risk and trust analyris, event correlation, and human-computer interaction (HCI).
