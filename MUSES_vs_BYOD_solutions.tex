...
\begin{description}
  ...
  \item[DEVICE PROTECTION SENSOR] Which scans device security settings, such as the time until the device screen tunrs off, if the device has the screen protected with a password, or even if the device is rooted \cite{hildenbrand2014}. This sensor adds the possibility of detecting security violations event if the user is not doing a specific action.
