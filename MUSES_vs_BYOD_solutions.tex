...
published. Also, an additional work on applying data mining and machine learning techniques was conducted in \cite{mora14:urls}. It presented a study over a dataset similar to those that MUSES manages, but not the same, since the prototype of MUSES had not still been released.
...
%  \resizebox{8cm}{!}{
  \begin{tabular}{>{\centering\bfseries}m{1in} >{\centering}m{1in} >{\centering}m{1in} >{\centering\arraybackslash}m{1in}}
    ...
    \midrule
    MUSES & Free software & IOS, Android, Windows Phone & Free  \\
...
since, in principle, it cannot predict (generate rules for dealing
