...
Table \ref{tab:taxonomy} summarizes the features of the main analyzed tools, regarding the proposed taxonomy of Section \ref{sec:toolsreview}. Also, Table \ref{tab:features} shows the features of the analyzed products considering licenses, type of devices and price.
