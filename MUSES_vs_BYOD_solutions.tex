...
As these tools have several different access levels and different detection methods. Therefore, we propose the next taxonomy in order to classify the BYOD methods described in this paper.
