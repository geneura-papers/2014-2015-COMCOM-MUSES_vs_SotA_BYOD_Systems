...
Section \ref{sec:muses} presents the Multi-platform Usable Endpoint Security System, with its architecture and the soft computing techniques it makes uses of. Advantages and benefits of the proposed system are compared to other solutions found in bibliography in Section \ref{sec:comparison}.
...
%  \resizebox{8cm}{!}{
  \begin{tabular}{>{\centering\bfseries}m{1in} >{\centering}m{1in} >{\centering}m{1in} >{\centering\arraybackslash}m{1in}}
    ...
    Samsung Knox and Blackberry Balance & Proprietary & IOS, Android, Samsung Devices & 12\$ per year/device \\
